...
namespace Cineplexx.Web.Controllers 
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<CineplexxUser> signInManager;
        public AccountController(UserManager<CineplexxUser> userManager, SignInManager<CineplexxUser> signInManager)
        {
